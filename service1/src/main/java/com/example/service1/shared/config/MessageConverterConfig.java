package com.example.service1.shared.config;

import com.example.service1.session.dto.RequestDTO;
import com.example.service1.session.dto.SuccessfulSessionCreationResponseDTO;
...
public class MessageConverterConfig
{
    ...
    public DefaultJackson2JavaTypeMapper defaultJackson2JavaTypeMapper()
    {
        ...
        defaultJackson2JavaTypeMapper.addTrustedPackages("org.springframework.util.concurrent");
